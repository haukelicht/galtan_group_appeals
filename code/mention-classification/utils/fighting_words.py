...
def bayes_compare_language(l1, l2, ngram = 1, prior=.01, cv = None, verbose=False):
    '''
    Arguments:
    ...
    if verbose: print("Vocab size is {}".format(vocab_size))
    ...
    if verbose: print("Comparing language...")
