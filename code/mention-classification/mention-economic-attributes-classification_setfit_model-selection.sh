...
DATA_DIR="../../data/annotations/group_mention_categorization/splits"
RESULTS_DIR="../../results/classifiers/${TASK}/model_selection/setfit"
...
# declare -A max_embedding_eval_steps
# max_embedding_eval_steps=(
#     ["mention_text"]=500
#     ["span_embedding"]=750
#     ["concat_prefix"]=500
#     ["concat_suffix"]=500
